...
<head>
  ...
  <title>Amit & Sonai — Wedding Invitation 💖</title>

  <link href="https://fonts.googleapis.com/css2?family=Noto+Serif+Bengali&family=Poppins:wght@400;600&display=swap" rel="stylesheet">

  <style>
    body {
      font-family: 'Poppins', sans-serif;
      background: radial-gradient(circle at top left, #fff8f0, #fce4ec, #f8bbd0);
      margin: 0;
      padding: 20px;
      color: #222;
      text-align: center;
    ...
    .petal {
      ...
      width: 25px;
      height: 25px;
      background: radial-gradient(circle, pink 30%, transparent 70%);
      border-radius: 50%;
      opacity: 0.8;
...
<body>
  ...
  <div class="invitation">
    ...
    <p>Your presence and blessings will make this day even more special.  
